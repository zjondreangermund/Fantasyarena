...
var require_define_length = __commonJS({
  "node_modules/es5-ext/function/_define-length.js"(exports2, module2) {
    ...
    if (test.length === 1) {
      desc2 = { configurable: true, writable: false, enumerable: false };
      defineProperty = Object.defineProperty;
      module2.exports = function(fn, length) {
        length = toPosInt(length);
        if (fn.length === length) return fn;
        desc2.value = length;
        return defineProperty(fn, "length", desc2);
      };
    } else {
      mixin = require_mixin();
...
var require_d = __commonJS({
  "node_modules/d/index.js"(exports2, module2) {
    ...
    var d = module2.exports = function(dscr, value) {
      ...
      desc2 = { value, configurable: c, enumerable: e, writable: w };
      return !options ? desc2 : assign(normalizeOpts(options), desc2);
    };
    d.gs = function(dscr, get, set) {
      ...
      desc2 = { get, set, configurable: c, enumerable: e };
      return !options ? desc2 : assign(normalizeOpts(options), desc2);
    };
  }
});
...
var require_generate_name = __commonJS({
  "node_modules/es6-symbol/lib/private/generate-name.js"(exports2, module2) {
    ...
    module2.exports = function(desc2) {
...
var require_shim5 = __commonJS({
  "node_modules/es5-ext/array/from/shim.js"(exports2, module2) {
    ...
    var call = Function.prototype.call;
    var desc2 = { configurable: true, enumerable: true, writable: true, value: null };
    var defineProperty = Object.defineProperty;
  ...
  "node_modules/memoizee/normalizers/get.js"(exports2, module2) {
    ...
    module2.exports = function() {
      ...
      return {
        ...
        delete: function(id) {
          var index2 = 0, set = map, i, args = cache[id], length = args.length, path2 = [];
          if (length === 0) {
            delete set[length];
  ...
  "node_modules/memoizee/normalizers/get-fixed.js"(exports2, module2) {
    ...
    module2.exports = function(length) {
      ...
      return {
        ...
        delete: function(id) {
          var index2 = 0, set = map, i, path2 = [], args = cache[id];
          while (index2 < length - 1) {
            i = indexOf.call(set[0], args[index2]);
            if (i === -1) {
              return;
...
// Fantasy-Sports-Exchange/shared/models/auth.ts
...
// Fantasy-Sports-Exchange/shared/schema.ts
var rarityEnum = (0, import_pg_core2.pgEnum)("rarity", ["common", "rare", "unique", "epic", "legendary"]);
var positionEnum = (0, import_pg_core2.pgEnum)("position", ["GK", "DEF", "MID", "FWD"]);
var transactionTypeEnum = (0, import_pg_core2.pgEnum)("transaction_type", ["deposit", "withdrawal", "purchase", "sale", "entry_fee", "prize", "swap_fee"]);
var competitionTierEnum = (0, import_pg_core2.pgEnum)("competition_tier", ["common", "rare"]);
var competitionStatusEnum = (0, import_pg_core2.pgEnum)("competition_status", ["open", "active", "completed"]);
var swapStatusEnum = (0, import_pg_core2.pgEnum)("swap_status", ["pending", "accepted", "rejected", "cancelled"]);
var withdrawalStatusEnum = (0, import_pg_core2.pgEnum)("withdrawal_status", ["pending", "processing", "completed", "rejected"]);
var paymentMethodEnum = (0, import_pg_core2.pgEnum)("payment_method", ["eft", "ewallet", "bank_transfer", "mobile_money", "other"]);
var players = (0, import_pg_core2.pgTable)("players", {
...
var playerCards = (0, import_pg_core2.pgTable)("player_cards", {
  id: (0, import_pg_core2.integer)("id").primaryKey().generatedAlwaysAsIdentity(),
...
var lineups = (0, import_pg_core2.pgTable)("lineups", {
  id: (0, import_pg_core2.integer)("id").primaryKey().generatedAlwaysAsIdentity(),
  userId: (0, import_pg_core2.varchar)("user_id").notNull().references(() => users.id).unique(),
...
var userOnboarding = (0, import_pg_core2.pgTable)("user_onboarding", {
  id: (0, import_pg_core2.integer)("id").primaryKey().generatedAlwaysAsIdentity(),
  userId: (0, import_pg_core2.varchar)("user_id").notNull().references(() => users.id).unique(),
...
var competitions = (0, import_pg_core2.pgTable)("competitions", {
  id: (0, import_pg_core2.integer)("id").primaryKey().generatedAlwaysAsIdentity(),
  name: (0, import_pg_core2.text)("name").notNull(),
...
var competitionEntries = (0, import_pg_core2.pgTable)("competition_entries", {
  id: (0, import_pg_core2.integer)("id").primaryKey().generatedAlwaysAsIdentity(),
...
var swapOffers = (0, import_pg_core2.pgTable)("swap_offers", {
  id: (0, import_pg_core2.integer)("id").primaryKey().generatedAlwaysAsIdentity(),
...
var withdrawalRequests = (0, import_pg_core2.pgTable)("withdrawal_requests", {
  id: (0, import_pg_core2.integer)("id").primaryKey().generatedAlwaysAsIdentity(),
  userId: (0, import_pg_core2.varchar)("user_id").notNull().references(() => users.id),
  amount: (0, import_pg_core2.real)("amount").notNull(),
...
var SITE_FEE_RATE = 0.08;
var eplPlayers = (0, import_pg_core2.pgTable)("epl_players", {
  id: (0, import_pg_core2.integer)("id").primaryKey().generatedAlwaysAsIdentity(),
...
var eplFixtures = (0, import_pg_core2.pgTable)("epl_fixtures", {
  id: (0, import_pg_core2.integer)("id").primaryKey().generatedAlwaysAsIdentity(),
  apiId: (0, import_pg_core2.integer)("api_id").notNull().unique(),
...
var eplInjuries = (0, import_pg_core2.pgTable)("epl_injuries", {
  id: (0, import_pg_core2.integer)("id").primaryKey().generatedAlwaysAsIdentity(),
...
var eplStandings = (0, import_pg_core2.pgTable)("epl_standings", {
  id: (0, import_pg_core2.integer)("id").primaryKey().generatedAlwaysAsIdentity(),
...
var eplSyncLog = (0, import_pg_core2.pgTable)("epl_sync_log", {
  id: (0, import_pg_core2.integer)("id").primaryKey().generatedAlwaysAsIdentity(),
...
var playersRelations = (0, import_drizzle_orm3.relations)(players, ({ many }) => ({
  cards: many(playerCards)
}));
var playerCardsRelations = (0, import_drizzle_orm3.relations)(playerCards, ({ one }) => ({
...
var walletsRelations = (0, import_drizzle_orm3.relations)(wallets, ({ one }) => ({
  user: one(users, { fields: [wallets.userId], references: [users.id] })
}));
var transactionsRelations = (0, import_drizzle_orm3.relations)(transactions, ({ one }) => ({
  user: one(users, { fields: [transactions.userId], references: [users.id] })
}));
var lineupsRelations = (0, import_drizzle_orm3.relations)(lineups, ({ one }) => ({
  user: one(users, { fields: [lineups.userId], references: [users.id] })
}));
var userOnboardingRelations = (0, import_drizzle_orm3.relations)(userOnboarding, ({ one }) => ({
  user: one(users, { fields: [userOnboarding.userId], references: [users.id] })
}));
var competitionsRelations = (0, import_drizzle_orm3.relations)(competitions, ({ many }) => ({
  entries: many(competitionEntries)
}));
var competitionEntriesRelations = (0, import_drizzle_orm3.relations)(competitionEntries, ({ one }) => ({
...
var swapOffersRelations = (0, import_drizzle_orm3.relations)(swapOffers, ({ one }) => ({
  offerer: one(users, { fields: [swapOffers.offererUserId], references: [users.id] })
}));
var withdrawalRequestsRelations = (0, import_drizzle_orm3.relations)(withdrawalRequests, ({ one }) => ({
  user: one(users, { fields: [withdrawalRequests.userId], references: [users.id] })
}));
var insertPlayerSchema = createInsertSchema(players);
var insertPlayerCardSchema = createInsertSchema(playerCards);
var insertWalletSchema = createInsertSchema(wallets);
var insertTransactionSchema = createInsertSchema(transactions);
var insertLineupSchema = createInsertSchema(lineups);
var insertOnboardingSchema = createInsertSchema(userOnboarding);
var insertCompetitionSchema = createInsertSchema(competitions);
var insertCompetitionEntrySchema = createInsertSchema(competitionEntries);
var insertSwapOfferSchema = createInsertSchema(swapOffers);
var insertWithdrawalRequestSchema = createInsertSchema(withdrawalRequests);
...
// Fantasy-Sports-Exchange/server/storage.ts
...
// Fantasy-Sports-Exchange/server/replit_integrations/auth/replitAuth.ts
...
// Fantasy-Sports-Exchange/server/replit_integrations/auth/storage.ts
...
// Fantasy-Sports-Exchange/server/replit_integrations/auth/routes.ts
...
// Fantasy-Sports-Exchange/server/seed.ts
var seedPlayers = [
